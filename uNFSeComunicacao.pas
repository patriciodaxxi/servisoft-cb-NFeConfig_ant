...
type
  ...
  protected
    ...
    procedure ConfigurarHttp(AHttp: THTTPReqResp; AMetodo: widestring); virtual;
...
procedure TNFSeComunicacao.ConfigurarHttp(AHttp: THTTPReqResp; AMetodo: widestring);
begin
end;
...
function TNFSeComunicacao.CriarHttp(AMetodo: widestring): THTTPReqResp;
begin
...
function TNFSeComunicacao.dirSchema: string;
begin
  Result := '\NFSe_Util\NFSE_Schemas\';
end;
...
begin
  ...
  schema_filename := ExtractFileDir(Application.ExeName) + dirSchema + schema_filename;
